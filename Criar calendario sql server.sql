...
set @dataInicial = '2000-01-01 00:00:00'
set @dataFinal = '2100-12-31 00:00:00'
...
set @nrSemanaMes = (DAY(@data) +(DATEPART(dw, DATEADD (month, DATEDIFF (month, 0, @data), 0))-1)-1)/7 + 1
